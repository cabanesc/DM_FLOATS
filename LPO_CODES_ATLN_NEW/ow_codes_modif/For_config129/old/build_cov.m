...
scale_lon_large = str2num(po_system_configuration.MAPSCALE_LONGITUDE_SMALL);
scale_lat_large = str2num(po_system_configuration.MAPSCALE_LATITUDE_SMALL);
scale_phi_large = str2num(po_system_configuration.MAPSCALE_PHI_SMALL);
map_use_pv = str2num(po_system_configuration.MAP_USE_PV);

for k=1:n
  b(k,:)=covarxy_pv(coord_float(k,:),coord_float,scale_lon_large,scale_lat_large,scale_phi_large,map_use_pv);
end
b=b(:,1:n);
