...
try
    ...
    use_theta_lt = po_system_configuration.use_theta_lt;
    use_theta_gt = po_system_configuration.use_theta_gt;
    use_pres_gt = po_system_configuration.use_pres_gt;
    use_pres_lt = po_system_configuration.use_pres_lt;
    use_percent_gt = 0.5;
end
