...
function plot_diagnostics_ow_figure9_3( pn_float_dir, pn_float_name, po_system_configuration,dacname,DIR_FTP )
...
contour(Topo.lon.data,Topo.lat.data,Topo.topo.data,[-3000 -3000],'LineColor',[0.8 0.7 0.6]);
contour(Topo.lon.data,Topo.lat.data,Topo.topo.data,[-4000 -4000],'LineColor',[0.8 0.8 0.8]);

contour(Topo.lon.data,Topo.lat.data,Topo.topo.data,[0 0],'LineColor',[0 0 0]); 
