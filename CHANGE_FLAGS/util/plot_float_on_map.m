...
plot(F.longitude.data,F.latitude.data,'-m','LineWidth',1)
scatter(F.longitude.data,F.latitude.data,s.MarkerSize,F.(Param).data,'o','filled')
scatter(F.longitude.data,F.latitude.data,s.MarkerSize,F.(Param).data,'mo')
