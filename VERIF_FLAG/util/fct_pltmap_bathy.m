...
%keyboard
[contourMatrix, contourHdl] = m_etopo2('contour', [-4000 -4000], 'color',[.4 .4 .8]);
[contourMatrix, contourHdl] = m_etopo2('contour', [-3000 -3000], 'color',[.6 .6 .9]);
[contourMatrix, contourHdl] = m_etopo2('contour', [-2000 -2000], 'color',[.8 .8 .9]);
...
ax=ylabel('Latitude','FontSize',10);
getpo=get(ax,'position');


getpo(1)=getpo(1) +getpo(1)*50/100;
% %getpo(2)=getpo(2) -getpo(2)*5/100;
 ax.Position=getpo;
