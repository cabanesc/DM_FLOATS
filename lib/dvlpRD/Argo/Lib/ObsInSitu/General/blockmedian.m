function [VARGD]=blockmedian(lon,lat,VAL,domain)
...
% block average
expre=['!blockmedian /tmp/tempucor.dat -R' num2str(domain.lonmin) '/' num2str(domain.lonmax) '/' num2str(domain.latmin) '/' num2str(domain.latmax)];
