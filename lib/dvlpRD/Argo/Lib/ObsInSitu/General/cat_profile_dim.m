...
%      keyboard
   ...
   % keyboard
    ...
    % champs vide dans Coi => on remplie Coi par des fillval
    ...
    % champs vide dans Cor => on remplie Cor par des fillval
    ...
    % champs uniquement dans Coi => on remplie Cor par des fillval
