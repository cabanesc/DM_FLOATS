...
%  CALLED SUBROUTINES:
%   define_first_expr (internal)
%   expdim            (external)
% __________________________________________________________________________________________________
function create_netcdf_allthefile_v8b(DIMS,VARS,ficout,CONFIG,verbose)
...
for k=1:NBVARS
	...
	% -------------------------------------------------------------------
	    ...
	    % Les 4 champs 'data', 'dim', 'type' et 'name' ne sont pas des attributs qu'on ecrit dans le fichier
